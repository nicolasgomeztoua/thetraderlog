...
export default async function ProtectedLayout({
	...
	// Fetch initial theme from user settings. This also seeds the RSC query
	// cache; wrapping in <HydrateClient> ships it to the client so the
	// SettingsHydration useQuery hydrates instead of refetching.
