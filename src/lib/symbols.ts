 ...
 * - Uses correct format for supported instruments
 *
 * Twelve Data supports:
 * - Forex pairs: EUR/USD, GBP/USD, etc.
 * - Commodities: XAU/USD (Gold), XAG/USD (Silver), BRENT, WTI
 * - Crypto: BTC/USD, ETH/USD
 *
 * Twelve Data does NOT support:
 * - CME index futures (ES, NQ, MNQ, MES, etc.)
 * - Most exchange-traded futures contracts
 */
export const TWELVE_DATA_SYMBOL_MAP: Record<string, string | null> = {
	...
	// Precious metals use forex-style format
	GC: "XAU/USD", // Gold
	MGC: "XAU/USD", // Micro Gold (same underlying)
	SI: "XAG/USD", // Silver
	SIL: "XAG/USD", // Micro Silver (same underlying)

	// Energy - Twelve Data uses specific symbols
	CL: "WTI/USD", // Crude Oil (WTI)
	MCL: "WTI/USD", // Micro Crude (same underlying)
	// NG: Not well supported on Twelve Data

	// === CME INDEX FUTURES (NOT Supported by Twelve Data) ===
	// These return null - we cannot fetch OHLC data for them
	ES: null, // S&P 500 E-mini
	MES: null, // Micro S&P 500
	NQ: null, // Nasdaq 100 E-mini
	MNQ: null, // Micro Nasdaq 100
	YM: null, // Dow Jones E-mini
	MYM: null, // Micro Dow
	RTY: null, // Russell 2000 E-mini
	M2K: null, // Micro Russell 2000
	NKD: null, // Nikkei

	// Currency futures (NOT supported - use forex pairs instead)
	"6A": null,
	"6B": null,
	"6C": null,
	"6E": null,
