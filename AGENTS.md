...
Reference documentation is organized in `.Codex/skills/` for AI-assisted development:

| Topic | Skill | Full Reference |
|-------|-------|----------------|
| Design System | `.Codex/skills/frontend/SKILL.md` | `.Codex/skills/frontend/DESIGN_REFERENCE.md` |
| Architecture | `.Codex/skills/architecture/SKILL.md` | `.Codex/skills/architecture/MARKET_DATA_REFERENCE.md` |
| Testing | `.Codex/skills/testing/SKILL.md` | `.Codex/skills/testing/TESTING_REFERENCE.md` |
| Planning | `.Codex/skills/planning/SKILL.md` | - |
| Code Quality | `.Codex/skills/consistency-audit/SKILL.md` | - |
| PRD Generation | `.Codex/skills/prd/SKILL.md` | - |
| UX Design | `.Codex/skills/ux/SKILL.md` | `.Codex/skills/ux/UX_REFERENCE.md` |
| Ralph Converter | `.Codex/skills/ralph/SKILL.md` | - |
| Compound Engineering | `.Codex/skills/compound-engineering/SKILL.md` | - |
...
Codex skills provide contextual guidance when invoked:
...
Ralph is an autonomous AI agent loop that executes PRD user stories one at a time, then creates a PR and handles Greptile AI code review. Based on [snarktank/ralph](https://github.com/snarktank/ralph), adapted for Codex.
...
- **Fix** - Codex addresses inline comments and summary concerns (skeptically — Greptile can be wrong)
